...
class Reply(models.Model):
    ...
    reply = models.ForeignKey("self", on_delete=models.CASCADE, related_name="reply_set", verbose_name="回复对象")
    user = models.ForeignKey(user, on_delete=models.CASCADE, verbose_name="回复者")
    created = models.DateTimeField(default=datetime, verbose_name="回复时间")
